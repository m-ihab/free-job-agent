...
// eslint-disable-next-line no-unused-vars -- shared classic-script helper used by deferred UI modules
...
function activateTab(name) {
  ...
  if (name === "tracker" && window.JobAgentTracker) window.JobAgentTracker.load();
